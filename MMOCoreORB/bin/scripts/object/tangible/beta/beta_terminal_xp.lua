...
--Added the following ->
		"Jedi Teachings",
		{
			"The hystory and teaching of the force!",
			{
				"Jedi Padawan Apprentice",  "combat_jedi_master",
				"The Force and how it works",  "combat_jedi_novice",
				"The Force",
				{
					"Light I",  "combat_jedi_light_01",
					"Light II",  "combat_jedi_light_02",
					"Light III",  "combat_jedi_light_03",
					"Light IV",  "combat_jedi_light_04",
					"Dark I",  "combat_jedi_dark_01",
					"Dark II",  "combat_jedi_dark_02",
					"Dark III",  "combat_jedi_dark_03",
					"Dark IV",  "combat_jedi_dark_04"
				},
			}
		},  -- <-
		"Jedi",
